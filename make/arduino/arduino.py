...
def generate_boards_txt_esp32(database, boards_txt_fmt):
    ...
    esp32_devkitc_compiler_c_elf_extra_flags = get_c_elf_extra_flags("ESP32", database)
    ...
    return boards_txt_fmt.format(
        ...
        esp32_devkitc_compiler_c_extra_flags=get_c_extra_flags("ESP32", database),
        esp32_devkitc_compiler_cxx_extra_flags=get_cxx_extra_flags("ESP32", database),
        esp32_devkitc_compiler_c_elf_extra_flags=esp32_devkitc_compiler_c_elf_extra_flags,
        esp32_devkitc_compiler_c_elf_libs=get_c_elf_libs("ESP32", database),
